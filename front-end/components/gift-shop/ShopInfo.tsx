        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-neutral-600 text-sm">
              Easily accessible from the main entrance and lobby area
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-neutral-600 text-sm">
              Extended hours available during special events and holidays
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-neutral-600 text-sm">
              With post-checkout delivery service to your home
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-neutral-600 text-sm">
              Exclusive access to limited edition items and early sales
            </p>
          </div>
        </div>
              ...
              <div className="space-y-6">
                <div className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600 text-sm">
                      Available for guests during their stay. Simply call the boutique or use the
                      in-room tablet to place your order.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600 text-sm">
                      We accept all major credit cards, mobile payments, and room charges for hotel
                      guests.
                    </p>
                  </div>
                </div>
