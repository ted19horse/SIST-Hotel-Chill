...
const categories = [
  {
    ...
    description:
      'Exclusive products featuring our signature scents and designs used throughout the hotel',
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-neutral-600 max-w-2xl mx-auto">
            Explore our thoughtfully curated collections designed to bring the Chill Haven
                ...
                <div className="space-y-2 mb-6">
                  ...
                  {category.featuredProducts.length > 3 && (
                    <p className="text-sm text-neutral-500">
                      + {category.featuredProducts.length - 3} more products
                    </p>
                  )}
                </div>
