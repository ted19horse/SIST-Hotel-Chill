          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-neutral-50 p-4 rounded-lg">
              ...
              <p className="text-neutral-600 text-sm">
                Suite guests receive priority for early check-in (from 12:00) and late check-out
            ...
            <div className="bg-neutral-50 p-4 rounded-lg">
              ...
              <p className="text-neutral-600 text-sm">
                Suite guests can access the Wellness Center from 5:30 to 23:00, extending beyond
                regular hours.
              </p>
            </div>
            ...
            <div className="bg-neutral-50 p-4 rounded-lg">
              ...
              <p className="text-neutral-600 text-sm">
                Suite guests receive priority reservations at all dining venues, including exclusive
                access to Chill Elegance.
              </p>
            </div>
          </div>
        </div>
