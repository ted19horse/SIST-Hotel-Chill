              ...
              <div className="relative">
                <div className="absolute -top-16 left-1/2 -translate-x-1/2 bg-white shadow-md rounded-lg p-3 w-48 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                  ...
                  <p className="text-xs text-neutral-600">
                    Hotel exterior gardens and surrounding natural environment
                  </p>
                </div>
                <Button
                  variant="outline"
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-4 md:mb-0">
                <p className="text-sm text-neutral-500">
                  * Hover over the pins to see facility details
                </p>
              </div>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <p className="text-sm text-neutral-600">
              Houses the Wellness Center (1st-2nd floor), Lounge & Entertainment (3rd floor),
              Business Chill (B1), and Kids & Family (B2)
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <p className="text-sm text-neutral-600">
              Dedicated to the Chill Serenity Spa with treatment rooms, relaxation areas, and
              private spa suites
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <p className="text-sm text-neutral-600">
              Includes the Nature Chill Zone with walking paths, gardens, lake deck, and seasonal
              activity areas
            </p>
          </div>
        </div>
