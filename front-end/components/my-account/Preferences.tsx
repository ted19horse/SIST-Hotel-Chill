...
import { BedDouble, Bell, Leaf, Mail, Save, Sparkles, Utensils } from 'lucide-react';
                      ...
                      if (checked) {
                        setPreferences({
                          ...
                          diningPreferences: {
                            ...
                            dietaryRestrictions: [
                              ...preferences.diningPreferences.dietaryRestrictions,
                              option.id,
                            ],
                          },
                        });
                        ...
                        setPreferences({
                          ...
                          diningPreferences: {
                            ...preferences.diningPreferences,
                            dietaryRestrictions:
                              preferences.diningPreferences.dietaryRestrictions.filter(
                                (id) => id !== option.id
                              ),
                          },
                        });
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-600">
                  Receive notifications about special deals and packages
                </p>
              </div>
            </div>
            <Switch
