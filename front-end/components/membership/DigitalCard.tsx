        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-neutral-600 mb-8">
              Access your Chill Rewards membership anytime, anywhere with our digital card in the
              Chill Haven mobile app.
            </p>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">
                    Your digital membership card is always with you in the Chill Haven app,
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">
                    Check your Chill Points balance, view your earning history, and track points
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">
                    Redeem your points directly through the app for room charges, dining, spa
                    treatments, and more with just a few taps.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">
                    Receive tailored offers, event invitations, and promotions based on your
                    preferences and membership tier.
                  </p>
                </div>
              </div>
            </div>
