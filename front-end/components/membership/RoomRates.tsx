      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-neutral-600 max-w-2xl mx-auto">
            Our transparent pricing helps you plan your stay and understand the value of your
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-4 bg-neutral-50 flex items-start">
            ...
            <p className="text-sm text-neutral-600">
              Peak season includes July-August summer season, December 20-January 5 year-end
              holidays, and major holiday periods. All rates are subject to 10% VAT. Membership
              discounts apply to these base rates.
            </p>
          </div>
        </div>
