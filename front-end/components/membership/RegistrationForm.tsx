        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-neutral-600">
              Sign up for our membership program to start enjoying exclusive benefits and earning
              Chill Points with every stay.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            {isSubmitted ? (
              <div className="text-center py-8">
                ...
                <p className="text-neutral-600">
                  Your registration has been submitted successfully. You'll receive a confirmation
                  email shortly with your membership details.
                </p>
              </div>
            ) : (
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <div className="grid gap-1.5 leading-none">
                      ...
                      <p className="text-sm text-neutral-500">
                        We'll send you updates about special offers, events, and promotions. You can
